...
.method public static bfsAddViewChildren(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Lro;->containedBeforeIndex(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Lro;->containedBeforeIndex(Ljava/util/List;Landroid/view/View;I)Z

    move-result v5

    if-nez v5, :cond_2

    invoke-static {v4}, Lnk0$i;->k(Landroid/view/View;)Ljava/lang/String;
...
.method public prepareSetNameOverridesReordered(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lnk0$i;->k(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Lnk0$i;->v(Landroid/view/View;Ljava/lang/String;)V
...
.method public setListenerForTransitionEnd(Landroidx/fragment/app/Fragment;Ljava/lang/Object;Lj8;Ljava/lang/Runnable;)V
    .locals 0
...
.method public setNameOverridesReordered(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3, v6}, Lnk0$i;->v(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, Lro$a;-><init>(ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p1, p5}, Ld50;->a(Landroid/view/View;Ljava/lang/Runnable;)V

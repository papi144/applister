...
.method public constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, Lhh0$f;->a:Landroid/view/ActionMode$Callback;

    iput-object p2, p0, Lhh0$f;->b:Landroid/widget/TextView;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lhh0$f;->f:Z
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Lhh0$f;->a:Landroid/view/ActionMode$Callback;
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object v0, p0, Lhh0$f;->b:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lhh0$f;->c:Ljava/lang/Class;
    ...
    iput-object v2, p0, Lhh0$f;->d:Ljava/lang/reflect/Method;

    iput-boolean v3, p0, Lhh0$f;->e:Z
    :try_end_0
    ...
    iput-boolean v5, p0, Lhh0$f;->e:Z

    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v2, p0, Lhh0$f;->e:Z

    if-eqz v2, :cond_1

    iget-object v2, p0, Lhh0$f;->c:Ljava/lang/Class;
    ...
    iget-object v2, p0, Lhh0$f;->d:Ljava/lang/reflect/Method;
    ...
    iget-object v9, p0, Lhh0$f;->b:Landroid/widget/TextView;

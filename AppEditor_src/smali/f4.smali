...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Lf4;->a:Landroid/widget/ProgressBar;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lf4;->a:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lf4;->c:[I

    invoke-static {v0, p1, v1, p2}, Lxh0;->m(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lxh0;

    move-result-object p1

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Lxh0;->f(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lf4;->a:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p0, v7, v1}, Lf4;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v1}, Lxh0;->f(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-object v1, p0, Lf4;->a:Landroid/widget/ProgressBar;

    invoke-virtual {p0, v0, p2}, Lf4;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lgo0;->b()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_8

    invoke-virtual {p0, v1, p2}, Lf4;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-interface {v0, p2}, Lgo0;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Lf4;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lf4;->b:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v0, p0, Lf4;->b:Landroid/graphics/Bitmap;

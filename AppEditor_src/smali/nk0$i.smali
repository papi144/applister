...
.method public static b(Landroid/view/View;Lrm0;Landroid/graphics/Rect;)Lrm0;
    .locals 1
...
.method public static j(Landroid/view/View;)Lrm0;
    .locals 6

    sget-boolean v0, Lrm0$a;->d:Z
    ...
    :try_start_0
    sget-object v1, Lrm0$a;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v1, Lrm0$a;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v2, Lrm0$a;->c:Ljava/lang/reflect/Field;
    ...
    invoke-direct {v2}, Lrm0$d;-><init>()V
    ...
    invoke-direct {v2}, Lrm0$c;-><init>()V

    goto :goto_0

    :cond_2
    new-instance v2, Lrm0$b;

    invoke-direct {v2}, Lrm0$b;-><init>()V
    ...
    invoke-static {v3, v4, v5, v1}, Lxs;->a(IIII)Lxs;

    move-result-object v1

    invoke-virtual {v2, v1}, Lrm0$e;->c(Lxs;)V
    ...
    invoke-static {v1, v3, v4, v0}, Lxs;->a(IIII)Lxs;

    move-result-object v0

    invoke-virtual {v2, v0}, Lrm0$e;->d(Lxs;)V

    invoke-virtual {v2}, Lrm0$e;->b()Lrm0;
...
.method public static u(Landroid/view/View;Lo40;)V
    .locals 2
    ...
    :cond_1
    new-instance v0, Lnk0$i$a;

    invoke-direct {v0, p0, p1}, Lnk0$i$a;-><init>(Landroid/view/View;Lo40;)V

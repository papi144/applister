...
.method private static getSortedCustomAttributes(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-direct {p0, v1}, Lrc0;-><init>(I)V
...
.method public sendReports(Ljava/util/concurrent/Executor;Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 8
    :goto_1
    invoke-virtual {v3, v2, v5}, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->enqueueReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;Z)Lcom/google/android/gms/tasks/Task;

    move-result-object v2

    new-instance v3, Lmf;

    invoke-direct {v3, p0, v4}, Lmf;-><init>(Ljava/lang/Object;I)V

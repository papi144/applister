...
.field private touchExplorationStateChangeListener:Lv;


# direct methods
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;Lxh0;)V
    .locals 6
    ...
    invoke-direct {v4, p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout$EndIconDelegates;-><init>(Lcom/google/android/material/textfield/EndCompoundLayout;Lxh0;)V
    ...
    invoke-direct {v4, v5}, Lq4;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->suffixTextView:Landroid/widget/TextView;

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initErrorIconView(Lxh0;)V

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initEndIconView(Lxh0;)V

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initSuffixTextView(Lxh0;)V
...
.method private addTouchExplorationStateChangeListenerIfNeeded()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:Lv;
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:Lv;

    invoke-static {v0, v1}, Lu;->a(Landroid/view/accessibility/AccessibilityManager;Lv;)Z
...
.method private createIconView(Landroid/view/ViewGroup;Landroid/view/LayoutInflater;I)Lcom/google/android/material/internal/CheckableImageButton;
    ...
    invoke-static {p2, v1}, Le10;->h(Landroid/view/ViewGroup$MarginLayoutParams;I)V
...
.method private initEndIconView(Lxh0;)V
    .locals 6
    ...
    invoke-static {v4, p1, v1}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Lxh0;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v1, v3}, Lxh0;->h(II)I
    ...
    invoke-virtual {p1, v1, v5}, Lxh0;->h(II)I
    ...
    invoke-virtual {p1, v0}, Lxh0;->k(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0, v1}, Lxh0;->a(IZ)Z
    ...
    :cond_5
    invoke-virtual {p1, v0, v5}, Lxh0;->a(IZ)Z
    ...
    invoke-virtual {p1, v0, v1}, Lxh0;->d(II)I
    ...
    invoke-virtual {p1, v0, v3}, Lxh0;->h(II)I
...
.method private initErrorIconView(Lxh0;)V
    .locals 2
    ...
    invoke-static {v1, p1, v0}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Lxh0;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v0, v1}, Lxh0;->h(II)I
...
.method private initSuffixTextView(Lxh0;)V
    .locals 4
    ...
    invoke-static {v0, v1}, Lnk0$g;->f(Landroid/view/View;I)V
    ...
    invoke-virtual {p1, v0}, Lxh0;->b(I)Landroid/content/res/ColorStateList;
...
.method private removeTouchExplorationStateChangeListenerIfNeeded()V
    ...
    invoke-static {v1, v0}, Lu;->b(Landroid/view/accessibility/AccessibilityManager;Lv;)Z
...
.method private setUpDelegate(Lcom/google/android/material/textfield/EndIconDelegate;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/material/textfield/EndIconDelegate;->getTouchExplorationStateChangeListener()Lv;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:Lv;
...
.method private tearDownDelegate(Lcom/google/android/material/textfield/EndIconDelegate;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:Lv;
...
.method private tintEndIconOnError(Z)V
    ...
    invoke-virtual {v0, p1}, Lb4;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public updateSuffixTextViewPadding()V
    ...
    invoke-static {v1, v2, v3, v0, v4}, Lnk0$e;->k(Landroid/view/View;IIII)V

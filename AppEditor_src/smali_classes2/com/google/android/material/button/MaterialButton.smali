...
.method private resetIconDrawable()V
    ...
    invoke-static {p0, v0, v1, v1, v1}, Lhh0$b;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v1, v1, v0, v1}, Lhh0$b;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v1, v0, v1, v1}, Lhh0$b;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method private updateIcon(Z)V
    ...
    invoke-static {v0, v2}, Lfj$b;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2, v0}, Lfj$b;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    :cond_4
    invoke-static {p0}, Lhh0$b;->a(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-super {p0}, Lk3;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-super {p0}, Lk3;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-super {p0, p1}, Lk3;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-super {p0, p1}, Lk3;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method public onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, Lk3;->onLayout(ZIIII)V
...
.method public onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lk3;->onTextChanged(Ljava/lang/CharSequence;III)V
...
.method public setIconTintResource(I)V
    ...
    invoke-static {v0, p1}, Lke;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    :cond_0
    invoke-super {p0, p1}, Lk3;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    :cond_0
    invoke-super {p0, p1}, Lk3;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V

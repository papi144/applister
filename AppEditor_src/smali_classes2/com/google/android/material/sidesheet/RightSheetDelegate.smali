...
.method public isSettling(Landroid/view/View;IZ)Z
    ...
    invoke-virtual {v0}, Lcom/google/android/material/sidesheet/SideSheetBehavior;->getViewDragHelper()Lvk0;
    ...
    invoke-virtual {v0, p2, p1}, Lvk0;->p(II)Z
    ...
    iput-object p1, v0, Lvk0;->r:Landroid/view/View;

    const/4 p1, -0x1

    iput p1, v0, Lvk0;->c:I

    invoke-virtual {v0, p2, p3, v1, v1}, Lvk0;->i(IIII)Z
    ...
    iget-object p2, v0, Lvk0;->r:Landroid/view/View;

    if-eqz p2, :cond_1

    const/4 p2, 0x0

    iput-object p2, v0, Lvk0;->r:Landroid/view/View;
